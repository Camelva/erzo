...
var (
	ErrNoToken = errors.New("can't get fresh client_id token")
...
type ErrNoClientID string

func (err ErrNoClientID) Error() string {
	return fmt.Sprintf("can't add client_id to request: %s", err)
}
